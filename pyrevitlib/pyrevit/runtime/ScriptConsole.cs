...
namespace PyRevitLabs.PyRevit.Runtime
{
    ...
    public static class ScriptConsoleConfigs
    {
        ...
        public static string InlineWaitBlock =
            "<div class=\"inlinewait\" id=\"inlnwait\">\u280b Preparing results...</div>";
        ...
        public partial class ScriptConsoleTemplate : pyRevitLabs.CommonWPF.Windows.AppWindow
        {
            ...
            private void ScriptOutput_SizeChanged(object sender, SizeChangedEventArgs e)
            {
                ...
                this.TitleForeground = isVisible == Visibility.Visible
                    ? Brushes.White
                    : new SolidColorBrush() { Color = Color.FromArgb(0xFF, 0x2c, 0x3e, 0x50) };
            }
        ...
        public partial class ScriptConsole : ScriptConsoleTemplate, IComponentConnector, IDisposable
        {
            ...
            public void InitializeComponent()
            {
                ...
                this.MinWidth = 700;
                this.Height = 600;
                this.MinHeight = this.TitleBarHeight;
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Maintainability",
            ...
            {
                get { return renderer.Document; }
            }

            public Version RendererVersion
            {
                get { return renderer.Version; }
            }
                ...
                if (ActiveDocument != null)
                {
                    ...
                    if (element.Style != null)
                    {
                        if (element.Style.Contains("display:"))
                            element.Style = Regex.Replace(element.Style, "display:.+?;", cssdisplay,
            ...
            public void SetProgressBarVisibility(bool visibility)
            {
                if (this.TaskbarItemInfo != null)
                    ...
                    this.TaskbarItemInfo.ProgressState = visibility
            ...
            public void UpdateProgressBar(float curValue, float maxValue)
            {
                ...
                if (ActiveDocument != null)
                {
                    ...
                    if (pbargraph.Style == null)
                        ...
                        pbargraph.Style = Regex.Replace(pbargraph.Style, "width:.+?;", newWidthStyleProperty,
                            RegexOptions.IgnoreCase);
                }
            }
            ...
            public void UpdateInlineWaitAnimation(bool state = true)
            {
                if (state)
                {
                    ...
                    _animationTimer.Tick += (sender, e) => { UpdateInlineWait(); };
